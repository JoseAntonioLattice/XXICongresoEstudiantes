...
Pseudo-fermions are bosonic variables with the same partition function.
...
$$\mathcal{L} = \frac{1}{4}F_{\mu\nu}F_{\mu\nu} + \sum_f\bar\psi^f(i\gamma_{\mu}D_{\mu}-m_0^f)\psi^f,$$
...
\begin{eqnarray*}
    ...
    & &\sum_{x,f,\mu}m_0^f\bar\psi^f_x\psi^f_x + \text{other terms}.
\end{eqnarray*}
\end{frame}
...
0 & 1\\
1 & 0
\end{pmatrix}, \ \ \ \gamma_1 = \begin{pmatrix}
0 & -i\\
i & 0
\end{pmatrix}.
$$
...
\begin{frame}{Topological charge with slab method}
